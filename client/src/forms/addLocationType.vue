  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add Location Type</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        <form @submit.prevent="locationType">
          <div class="card">
            <div class="card-body">
              <div class="row mb-2">
                <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="name">Location Type Name</label>
                    <input type="text" v-model="formData.name" class="form-control" id="name" placeholder="Enter Location Type Name" required>
                  </div>
                </div>
              </div>
            </div>
...
export default {
    ...
    async mounted(){
       if(this.id !=0){
        let url=`${process.env.BACKEND_URL}/getLocationTypeById/${this.id}`;
    ...
    methods:{
      async locationType(){
        ...
        await axios.post(`${url}/locationType`, {
          id:this.formData.id,
